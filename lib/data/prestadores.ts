...
export const prestadores: Lugar[] = [
  // Dentista
  {
    ...
    enderecoGoogleMaps: 'https://maps.app.goo.gl/uzM2zQuXzFbt6KMh9',
  ...
  // Lash Designer
  {
    ...
    endereco: 'Blumenau-SC',
    enderecoGoogleMaps: 'https://maps.app.goo.gl/kyuD8kjensETBVLm8',
  ...
  // Nail Designer
  {
    ...
    endereco: 'Blumenau-SC',
    enderecoGoogleMaps: 'https://maps.app.goo.gl/D9M61ZUjB5UTfYXV8',
  ...
  // Sobrancelhas, pele e boca
  {
    ...
    categoria: 'beleza',
    subcategoria: 'Sobrancelhas, pele e boca',
  ...
  // Maquiagem e penteado
  {
    ...
    nome: 'Milena Bett',
    categoria: 'beleza',
    subcategoria: 'Maquiagem e penteado',
    ...
    endereco: 'Blumenau-SC',
    enderecoGoogleMaps: 'https://maps.app.goo.gl/VhULo4R7v3Eke6Dv5',
  ...
  },
  {
    ...
    endereco: 'Blumenau-SC',
    enderecoGoogleMaps: 'https://maps.app.goo.gl/kfeBcHbdB8bhmB5x7',
  ...
  // Arquitetura
  {
    ...
    endereco: 'Blumenau-SC',
    enderecoGoogleMaps: 'https://maps.app.goo.gl/WzFbSj8y7GfNb2Fr6',
