...
export const cafes: Lugar[] = [
  ...
  },
  {
    ...
    enderecoGoogleMaps: 'https://maps.app.goo.gl/RSMYnWYu6sjhLFCG7',
    enderecoGoogleMapsLabel: 'Humberto de Campos',
    enderecoGoogleMaps2: 'https://maps.app.goo.gl/koVi61F11PaQPHf69',
    enderecoGoogleMaps2Label: 'Centro',
